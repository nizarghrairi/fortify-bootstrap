...
namespace nizarghrairi\FortifyBootstrap;
    ...
    public function boot()
    {
        ...
        if (class_exists(Fortify::class)){
            ...
            Fortify::requestPasswordResetLinkView(function () {
                return file_exists(resource_path('views/auth/forget-password.blade.php'))
                    ? view('auth.forget-password')
                    : view('fortify-bootstrap::auth.forget-password') ;
            });
